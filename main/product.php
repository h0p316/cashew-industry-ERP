...
if (isset($_POST['order'])) 
{
  $oname = $_POST['user_name'];
	 ...
	 $oprice = $_POST['price'];
	 $sql = "UPDATE user (user_name,order_id,address,mobile,price)
  ...
  { 
	...
	$oname = $_POST['user_name'];
	 ...
	 $pass = $_POST['password'];
	 $oid = $_POST['order_id'];
	   $sql = "INSERT INTO user (user_name,address,mobile,price,password,order_id)
	   VALUES ( '$oname','$oaddress','$omobile','$price','$pass','$oid')";
	...
	{ 
	  ...
	  $oname = $_POST['user_name'];
	   ...
	   $pass = $_POST['password'];
	   $oid = $_POST['order_id'];
		 $sql = "UPDATE user SET (address = $oaddress ,mobile = $omobile ,price = $price, password = $pass , order_id = $oid) WHERE user_name = $oname ";
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <form class="row contact_form" action="product.php" method="post" novalidate="novalidate">
			  ...
			  <div class="col-md-6 form-group p_star">
                Password <input type="text" class="form-control" id="first" name="password" />
              ...
              <div class="col-md-12 form-group">
                <div class="creat_account">
				  ...
				  <input type="submit" name="order2" style="margin-top:5px;" class="btn btn-success" value="BUY" />
                </div>
              </div>
            </form>
          </div>
